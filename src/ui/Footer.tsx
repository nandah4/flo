            ...
            <div className="relative z-10 w-full max-w-[1920px] mx-auto px-6 md:px-10 2xl:px-20">
                <div className="grid grid-cols-1 md:grid-cols-12 gap-12 md:gap-8 mb-16">
                    ...
                    <div className="md:col-span-4 flex items-center lg:items-start flex-col gap-4">
                        ...
                        <p className="text-text-secondary text-sm md:text-base 2xl:text-lg leading-relaxed max-w-sm text-center lg:text-left">
                    ...
                    <div className="md:col-span-8 flex flex-col md:items-end justify-center gap-4 mt-6 md:mt-0">
                        <h4 className="font-medium! text-text-primary text-center md:text-right 2xl:text-xl">Quick Links</h4>
                        <div className="flex flex-wrap gap-x-8 gap-y-4 justify-center md:justify-end">
                            <a href="#hero" className="text-text-secondary! hover:text-primary! transition-colors text-sm md:text-base 2xl:text-lg font-normal">Home</a>
                            <a href="#features" className="text-text-secondary! hover:text-primary! transition-colors text-sm md:text-base 2xl:text-lg font-normal">Features</a>
                            <a href="#how-to-use" className="text-text-secondary! hover:text-primary! transition-colors text-sm md:text-base 2xl:text-lg font-normal">How to Use</a>
                            <a href="#testimonials" className="text-text-secondary! hover:text-primary! transition-colors text-sm md:text-base 2xl:text-lg font-normal">Testimonials</a>
                        </div>
                    </div>
                </div>
                ...
                <div className="pt-8 border-t border-gray-300 flex flex-col sm:flex-row justify-between items-center gap-4">
                    <p className="text-sm font-normal md:text-base 2xl:text-lg text-text-secondary">
