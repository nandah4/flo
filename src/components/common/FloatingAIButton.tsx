...
const FloatingAIButton: React.FC<FloatingAIButtonProps> = ({ onClick }) => {
    return (
        <button
            onClick={onClick}
            className="fixed bottom-24 sm:bottom-8 cursor-pointer right-8 w-14 h-14 2xl:w-16 2xl:h-16 rounded-full bg-white border shadow-xl shadow-secondary/20 hover:scale-110 hover:-translate-y-1 hover:shadow-2xl hover:shadow-primary/40 transition-all duration-300 z-40 border-secondary p-1!"
